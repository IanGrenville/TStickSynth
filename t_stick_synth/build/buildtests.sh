...
then
  /nix/store/rcakkm09fivblba082qb6jch02926qhq-ninja-1.11.1/bin/ninja $targets_to_make ${EIGEN_MAKE_ARGS}
else
  /nix/store/rcakkm09fivblba082qb6jch02926qhq-ninja-1.11.1/bin/ninja $targets_to_make 
fi
exit $?
